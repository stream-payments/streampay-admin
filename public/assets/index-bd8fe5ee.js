...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var qa=typeof Symbol=="function"?Symbol.toStringTag:"",Ka=qa;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var za=Ja,b=Ka,O=br;function Qa(r){var a,e,t;if(r==null)return O.call(r);e=r[b],a=za(r,b);try{r[b]=void 0}catch{return O.call(r)}return t=O.call(r),a?r[b]=e:delete r[b],t}var Ya=Qa;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var ke=Ke,I=Qe,ar=Ze;function rt(){var r,a;if(typeof ar!="function")return!1;try{a=[1,3.14,-3.14,I+1,I+2],a=new ar(a),r=ke(a)&&a[0]===1&&a[1]===3&&a[2]===I-2&&a[3]===0&&a[4]===1}catch{r=!1}return r}var at=rt;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Vt=V,xt=x,hr=Bt,dr=new xt(1),nr=new Vt(dr.buffer),Jt=hr.HIGH,qt=hr.LOW;function Kt(r,a,e,t){return dr[0]=r,a[t]=nr[Jt],a[t+e]=nr[qt],a}var gr=Kt;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var zt=gr;function Qt(r){return zt(r,[0>>>0,0>>>0],1,0)}var Yt=Qt;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Kn=Nr,zn=qn,Qn=$r;function Yn(r){var a=Kn(r);return a=(a&zn)>>>20,a-Qn|0}var Zn=Yn;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var ai=sr,ei=cr,ti=$r,ni=Jr,ii=Kr,oi=Qr,li=pr,fi=yr,ui=In,vi=xn,si=ri,ci=wr,$i=Pr,pi=2220446049250313e-31,yi=2148532223>>>0,P=[0,0],T=[0,0];function _i(r,a){var e,t;return r===0||li(r)||fi(r)?r:(vi(P),r=P[0],a+=P[1],a+=si(r),a<oi?ui(0,r):a>ni?r<0?ei:ai:(a<=ii?(a+=52,t=pi):t=1,ci(T),e=T[0],e&=yi,e|=a+ti<<20,t*$i(e,T[1])))}var bi=_i;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*

...
export declare type StoreType = 'cookie' | 'localStorage' | 'memory';
declare type StorageObject = Record<string, unknown>;
declare class Store {
    private cache;
...
export declare class User {
    ...
    traits: (traits?: Traits | null | undefined) => Traits | undefined;

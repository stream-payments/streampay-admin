...
var EventFactory = (
  ...
  function() {
    ...
    EventFactory2.prototype.normalize = function(event) {
      ...
      var body = __assign(__assign(__assign({ timestamp: new Date() }, rest), { integrations: allIntegrations, context }), overrides);
...
// node_modules/@segment/analytics-core/dist/esm/utils/environment.js
function isBrowser() {
  return typeof window !== "undefined";
}

// node_modules/@segment/analytics-core/dist/esm/connection/index.js
function isOnline() {
  if (isBrowser()) {
...
//# sourceMappingURL=chunk-5UWOIAPT.js.map
